                              ...
                              <table width="100%" height="100%">
                                 <tr>
                                    <td align="center" valign="middle">
                                     <img src="data:image/png;base64,${qrCodeBase64}" style="max-width: 100%; max-height: 100%; height: auto; width: auto;border-radius:15px">
                                    </td>
                                 </tr>
                              </table>
                           </div>
                     ...
                     <tr>
                        <td align="left">
                           <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                              <tbody>
                                 <tr>
                                    <td> <a href="#" target="_blank" style="background-color: #3B98E6 !important;border-color: #3B98E6 !important;" class="dynamic-btn">${type}</a> </td>
                                 </tr>
                              </tbody>
                           </table>
                        </td>
